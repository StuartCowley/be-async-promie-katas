...
// Example:
// returnTen() resolves to the value 1
...
// Create a function that returns a promise. The promise 
// should resolve to a new function that returns "My 
// name is <input name>"
// Example:
// A call to myNameIs() resolves to a new function that
// takes one argument, name, and returns "My name is name" 
// Eg (name) => `My name is ${name}`
